<template>
  ...
  <div class="sales-board">
    ...
    <div class="sales-board-form">
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          <!-- 将子组件传递过来countss的数据使用内联处理器的方法，获取dom -->
    ...
    <div class="sales-board-des">
      <h2>产品说明</h2>
      <p>网站的访问的统计分析报告的基础数据源于网站流量统计信息，但其价值远高于原始数据资料
      。专业的网站访问统计分析报告对网络营销的价值，正如专业的财务分析报告对企业营销的价值</p>
      <h3>用户行为指标</h3>
      <ul>
        <li>用户行为指标主要反映用户是如何来到网站的、在网站上停留了多长时间、访问了那些页面等，
        主要的统计指标包括：</li>
        <li>用户在网站的停留时间：</li>
