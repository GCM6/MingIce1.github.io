  ...
  <div class="heard-h">
    <div class="sales-board">
      ...
      <div class="sales-board-des">
        <h2>产品说明</h2>
        <p>本产品是只面向学生群体的一款产品，只需付一半费用即可</p>
        <h3>学生用户行为指标</h3>
        <ul>
          <li>学生用户行为指标主要反映用户是如何来到网站的、在网站上停留了多长时间、访问了那些页面等，从所周知学生浏览各个网站
            的流量是不可忽视的
            主要的统计指标包括：</li>
          <li>学生用户在网站的停留时间：</li>
          <li>学生用户来源网站（也叫“引导网站”）</li>
          <li>学生用户所用的搜索引擎及其关键字</li>
